-- Seed sections, video, and timestamps for Trio in G major
...
BEGIN
  ...
  -- Clean up existing data for this piece (idempotent)
  ...
  INSERT INTO piece_sections (id, piece_id, label, parent_id, sort_order, status, target_tempo) VALUES
    ...
    (v_c, v_piece_id, 'C', NULL, 2, 4, NULL),
    (v_d, v_piece_id, 'D', NULL, 3, 0, NULL),
    (v_e, v_piece_id, 'E', NULL, 4, 0, NULL),
    (v_f, v_piece_id, 'F', NULL, 5, 0, NULL),
    (v_g, v_piece_id, 'G', NULL, 6, 0, NULL),
    (v_h, v_piece_id, 'H', NULL, 7, 0, NULL),
    (v_i, v_piece_id, 'I', NULL, 8, 0, NULL);

  -- Child sections
  INSERT INTO piece_sections (id, piece_id, label, parent_id, sort_order, status, target_tempo) VALUES
    (v_a1, v_piece_id, 'A1', v_a, 0, 0, NULL),
    (v_a2, v_piece_id, 'A2', v_a, 1, 0, NULL),
    (v_a3, v_piece_id, 'A3', v_a, 2, 0, NULL),
    (v_b1, v_piece_id, 'B1', v_b, 0, 2, NULL),
    (v_b2, v_piece_id, 'B2', v_b, 1, 1, 108),
    (v_c1, v_piece_id, 'C1', v_c, 0, 5, NULL),
    (v_c2, v_piece_id, 'C2', v_c, 1, 3, NULL),
    (v_c3, v_piece_id, 'C3', v_c, 2, 0, NULL),
    (v_c4, v_piece_id, 'C4', v_c, 3, 0, NULL),
    (v_c5, v_piece_id, 'C5', v_c, 4, 0, NULL),
    (v_d1, v_piece_id, 'D1', v_d, 0, 0, NULL),
    (v_d2, v_piece_id, 'D2', v_d, 1, 0, NULL),
    (v_d3, v_piece_id, 'D3', v_d, 2, 0, NULL),
    (v_f1, v_piece_id, 'F1', v_f, 0, 0, NULL),
    (v_f2, v_piece_id, 'F2', v_f, 1, 0, NULL),
    (v_f3, v_piece_id, 'F3', v_f, 2, 0, NULL);
