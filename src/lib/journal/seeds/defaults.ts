...
export const BUILTIN_QUESTION_TYPES: BuiltinQuestionType[] = [
  ...
  { name: "me-topic", weight: 6, sort_order: 4, base_description: "Draws on your Present doc — projects, interests, people — and asks about one, rotating so it doesn't fixate on the same thing. Never asks about upcoming calendar events or anything still to come — that's the upcoming-events question type's job." },
  ...
  { name: "daily-recap", weight: 6, sort_order: 8, base_description: "Asks about a small, concrete moment from yesterday — something that already happened — leaning on your calendar rather than past entries. Never asks about today or anything still upcoming." },
